  ...
  return {
    ...
    link: function( scope ) {
      ...
      if ( typeof scope.disqus_identifier === 'undefined' || typeof scope.disqus_url === 'undefined' ) {
        throw 'Please ensure that the `disqus-identifier` and `disqus-url` attributes are both set.'  // eslint-disable-line no-throw-literal
      }

      scope.$watch( 'readyToBind', function( isReady = 'true' ) {
        var dsq
